...
#pragma HLS stream variable=s_query_vectors depth=512
    ...
    hls::stream<struct_8_float_t> s_center_vectors;
...
void load_center_vectors(
    ...
    struct_8_float_t packed_center_vectors[8];
    for (int i = 0; i < M; i++) {
        packed_center_vectors[i].val_0 = center_vector_buffer[i * 8 + 0];
        packed_center_vectors[i].val_1 = center_vector_buffer[i * 8 + 1];
        packed_center_vectors[i].val_2 = center_vector_buffer[i * 8 + 2];
        packed_center_vectors[i].val_3 = center_vector_buffer[i * 8 + 3];
        packed_center_vectors[i].val_4 = center_vector_buffer[i * 8 + 4];
        packed_center_vectors[i].val_5 = center_vector_buffer[i * 8 + 5];
        packed_center_vectors[i].val_6 = center_vector_buffer[i * 8 + 6];
        packed_center_vectors[i].val_7 = center_vector_buffer[i * 8 + 7];
    }
