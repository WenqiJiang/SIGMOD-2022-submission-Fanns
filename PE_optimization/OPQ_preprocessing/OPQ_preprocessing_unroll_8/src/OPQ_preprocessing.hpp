...
const int opq_unroll_width = 8; //vectorized computation of 8 numbers
...
#pragma HLS pipeline II=1
                ...
                float partial_result = 
                    ...
                    query_buffer[c * opq_unroll_width + 4] * OPQ_mat[r][c * opq_unroll_width + 4] +
                    query_buffer[c * opq_unroll_width + 5] * OPQ_mat[r][c * opq_unroll_width + 5] +
                    query_buffer[c * opq_unroll_width + 6] * OPQ_mat[r][c * opq_unroll_width + 6] +
                    query_buffer[c * opq_unroll_width + 7] * OPQ_mat[r][c * opq_unroll_width + 7];
