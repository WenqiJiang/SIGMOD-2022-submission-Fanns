...
#define PE_NUM_CENTER_DIST_COMP 2
#define PE_NUM_CENTER_DIST_COMP_EVEN 1
...
#define NPROBE_PER_TABLE_CONSTRUCTION_PE_LARGER 7 //9
#define NPROBE_PER_TABLE_CONSTRUCTION_PE_SMALLER 6 //8

// stage 5
#define HBM_CHANNEL_NUM 9 // PE num = 3 * HBM_CHANNEL_NUM
