...
#pragma HLS inline
            ...
            sort_reduction_with_vecID::replicate_s_control_iter_num_per_query<query_num, 3>(
                s_control_iter_num_per_query,
                s_control_iter_num_per_query_replicated); 

            for (int s = 0; s < 2; s++) {
#pragma HLS UNROLL
                sort_reduction_with_vecID::bitonic_sort_16<query_num>(
            ...
            sort_reduction_with_vecID::parallel_merge_sort_16<query_num>(
...
#pragma HLS inline
            ...
            sort_reduction_with_vecID::replicate_s_control_iter_num_per_query<query_num, 5>(
                s_control_iter_num_per_query,
                s_control_iter_num_per_query_replicated); 
...
#pragma HLS inline
            ...
            sort_reduction_with_vecID::replicate_s_control_iter_num_per_query<query_num, 7>(
                s_control_iter_num_per_query,
                s_control_iter_num_per_query_replicated); 
